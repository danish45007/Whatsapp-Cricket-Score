...
class ScoreGet:
    ...
    def get_unique_id(self):
        ...
        for i in resp_dict['matches']:
            if (i['team-1'] == "Ragama Cricket Club" or i['team-2'] == "India") and i['matchStarted']:
...
if __name__ == "__main__":
    ...
    account_sid = 'Unique Code'
    auth_token = 'Unique Code'
    client = Client(account_sid, auth_token)
    message = client.messages.create( body=send_message, from_='whatsapp:+14155238886', to='whatsapp:+91Whatsapp number' )
